...
public class Deroulement {
	...
	private static <T> Letter<?> createRandomLetter(Inhabitant senderI, Inhabitant receiverI) {
		// TODO Auto-generated method stub
		Random rand = new Random();
		Letter<?> letter;
		...
		switch(rand.nextInt(7))
		{
			case 0 : 
				...
				break;
			case 1 : 
				letter = new RegistredLetter<Letter<?>>( createRandomLetter(senderI, receiverI));
				break;
			case 2 : 
				letter = new UrgentLetter<Letter<?>>( createRandomLetter(senderI, receiverI));
				break;
			default : letter = new SimpleLetter(senderI, receiverI,new Text<String>("bonjour "+ receiverI.toString()));
		}
		return letter;
	}
}
